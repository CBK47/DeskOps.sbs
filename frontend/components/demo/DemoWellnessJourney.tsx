...
import { DemoRebalance } from "@/components/demo/DemoRebalance";
    ...
    <div className="space-y-6">
      ...
      <section className="surface-panel p-5 sm:p-7" aria-labelledby="wellness-queue-link-title">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          The sample Rebalance step above uses the latest tracked gaps, then waits for Add, Edit or Not now. The rating stays private. The person chooses whether it influences the queue at all.
        </p>
