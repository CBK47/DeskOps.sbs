...
- Design contract: `DESIGN.md` (tokens, motion rules, chip palettes, engineering landmines — read it).
- Deploy: `npm run pages:build && wrangler pages deploy .vercel/output/static --project-name deskops --branch main`. Verify the LIVE domain after.
